...
class ChatScreenStyles {
  ...
  static const myBubbleTextStyle =
      TextStyle(color: Colors.white, fontSize: AppTokens.fontBodyM);
  static const otherBubbleTextStyle = TextStyle(
      color: AppTokens.colorTextPrimary, fontSize: AppTokens.fontBodyM);

  static const timeStyle =
      TextStyle(color: AppTokens.colorTextSecondary, fontSize: 11);
