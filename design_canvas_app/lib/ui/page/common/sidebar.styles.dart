...
class SidebarStyles {
  ...
  static const loginTextStyle = TextStyle(color: AppTokens.colorTextPrimary, fontSize: AppTokens.fontBodyL);

  // Profile Header
  static const profileImageMargin = EdgeInsets.only(left: AppTokens.spaceM, top: AppTokens.spaceS);
  ...
  static final profileImageDecoration = BoxDecoration(
    border: Border.all(color: AppTokens.colorBorderInverse, width: AppTokens.borderWidthThick),
    borderRadius: BorderRadius.circular(profileImageSize / 2),
  );

  // Typography
  static const displayNameStyle = TextStyle(color: AppTokens.colorTextPrimary, fontSize: AppTokens.fontHeadingL, fontWeight: FontWeight.bold);
  static const userNameStyle = TextStyle(color: AppTokens.colorTextSecondary, fontSize: AppTokens.fontBodyS);
  static const statCountStyle = TextStyle(fontWeight: FontWeight.bold, fontSize: AppTokens.fontBodyM);
  static const statLabelStyle = TextStyle(color: AppTokens.colorTextSecondary, fontSize: AppTokens.fontBodyM);
  ...
  static Color menuColor(bool isEnable) => isEnable ? AppTokens.colorIconActive : AppTokens.colorIconInactive;
